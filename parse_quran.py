#!/usr/bin/env python3
"""
Скрипт для парсинга Корана с сайта islam.global и создания JSON файла
с арабским текстом, транскрипцией и русским переводом аятов.
"""
...
def main():
    print("Начинаю парсинг Корана с сайта islam.global...")
    
    quran_data = {}
    
    # Всего 114 сур в Коране
    ...
    with open('/workspace/quran_data_corrected.json', 'w', encoding='utf-8') as f:
        json.dump(quran_data, f, ensure_ascii=False, indent=2)
    
    print("Парсинг завершен. Данные сохранены в quran_data_corrected.json")
